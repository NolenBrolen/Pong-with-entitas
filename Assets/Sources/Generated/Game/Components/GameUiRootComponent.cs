...
public partial class GameContext {
    ...
    public UiRoot uiRoot { get { return uiRootEntity.uiRoot; } }
    public bool hasUiRoot { get { return uiRootEntity != null; } }

    public GameEntity SetUiRoot(UnityEngine.RectTransform newRoot) {
        if (hasUiRoot) {
            throw new Entitas.EntitasException("Could not set UiRoot!\n" + this + " already has an entity with UiRoot!",
                "You should check if the context already has a uiRootEntity before setting it or use context.ReplaceUiRoot().");
        }
        var entity = CreateEntity();
        entity.AddUiRoot(newRoot);
        return entity;
    }

    public void ReplaceUiRoot(UnityEngine.RectTransform newRoot) {
        var entity = uiRootEntity;
        if (entity == null) {
            entity = SetUiRoot(newRoot);
        } else {
            entity.ReplaceUiRoot(newRoot);
        }
    }
...
public partial class GameEntity {
    ...
    public UiRoot uiRoot { get { return (UiRoot)GetComponent(GameComponentsLookup.UiRoot); } }
    public bool hasUiRoot { get { return HasComponent(GameComponentsLookup.UiRoot); } }

    public void AddUiRoot(UnityEngine.RectTransform newRoot) {
        var index = GameComponentsLookup.UiRoot;
        var component = CreateComponent<UiRoot>(index);
