...
public partial class GameEntity {
    ...
    public void AddCollision(UnityEngine.GameObject newOwner, UnityEngine.GameObject newPartnerInCrime) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.owner = newOwner;
        component.partnerInCrime = newPartnerInCrime;
        AddComponent(index, component);
    }

    public void ReplaceCollision(UnityEngine.GameObject newOwner, UnityEngine.GameObject newPartnerInCrime) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.owner = newOwner;
        component.partnerInCrime = newPartnerInCrime;
