...
public partial class GameEntity {
    ...
    public void AddTrigger(UnityEngine.GameObject newTriggerOwner, UnityEngine.GameObject newTriggerObject) {
        var index = GameComponentsLookup.Trigger;
        var component = CreateComponent<TriggerComponent>(index);
        component.triggerOwner = newTriggerOwner;
        component.triggerObject = newTriggerObject;
        AddComponent(index, component);
    }

    public void ReplaceTrigger(UnityEngine.GameObject newTriggerOwner, UnityEngine.GameObject newTriggerObject) {
        var index = GameComponentsLookup.Trigger;
        var component = CreateComponent<TriggerComponent>(index);
        component.triggerOwner = newTriggerOwner;
        component.triggerObject = newTriggerObject;
